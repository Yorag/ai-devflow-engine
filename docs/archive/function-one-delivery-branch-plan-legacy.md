...
| DB08 | `feat/control-plane-core` | C2.1-C2.4 | DB05, DB06, DB07 | S | merged | control routes、Project/Session/Template service、audit hooks | Project、Session、系统模板和用户模板核心控制面 |
| DB09 | `feat/provider-delivery-runtime-settings` | C2.5, C2.6, C2.7, C2.7a, C2.8 | DB05, DB06, DB07, DB08 | S | ready_for_review | Provider、DeliveryChannel、配置包、PlatformRuntimeSettings service | Provider、DeliveryChannel、配置包和平台运行设置管理 |
