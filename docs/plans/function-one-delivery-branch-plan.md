...
| DB06 | `feat/persistence-boundaries` | C1.5-C1.9, L1.2 | DB04, DB05 | S | claimed | 数据库 session、control/runtime/graph/event/log models、Alembic migration 链 | 多 SQLite 职责库、模型和迁移边界 |
