...
| DB07 | `feat/observability-control-audit` | L2.1-L2.4 | DB05, DB06 | S | claimed | request context、redaction、JSONL writer、AuditService | API 关联上下文、payload 裁剪、日志写入和控制面审计 |
