...
def test_runtime_instructions_define_real_development_boundaries() -> None:
    ...
    assert asset.prompt_version == "2026-05-07.1"
    ...
    assert "Return the stage response required by response_schema" in body
    assert "runtime wraps that response into its internal AgentDecision" in body
