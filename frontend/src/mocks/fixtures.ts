...
const stageNode: TopLevelFeedEntry = {
  ...
  items: [
    {
      item_id: "stage-item-reasoning",
      type: "reasoning",
      occurred_at: "2026-05-01T09:13:00.000Z",
      title: "Reasoning trace",
      summary: "Keep the Narrative Feed as the center of gravity.",
      content: "Navigation state remains outside the main execution feed.",
      artifact_refs: [],
      metrics: {},
    },
    {
      item_id: "stage-item-model-call",
      type: "model_call",
      occurred_at: "2026-05-01T09:13:20.000Z",
      title: "Call deepseek-chat",
      summary: "Need to inspect the stage shell before changing homepage copy.",
      content: null,
      artifact_refs: [],
      metrics: {
    ...
    },
    {
      ...
      type: "decision",
      occurred_at: "2026-05-01T09:13:35.000Z",
      title: "Request tool call",
      summary: "Read the current stage container before drafting the change.",
      content: null,
      artifact_refs: [],
      metrics: {
        status: "accepted",
    ...
    {
      item_id: "stage-item-tool-call",
      type: "tool_call",
      occurred_at: "2026-05-01T09:14:00.000Z",
      title: 'read_file path="frontend/src/features/feed/StageNode.tsx"',
      summary: "Read the stage container to confirm the shell layout boundary.",
      content:
        'read_file path="frontend/src/features/feed/StageNode.tsx"\nOutput summary: StageNode renders the stage shell and overview metrics.',
      artifact_refs: [],
      metrics: {},
    },
    {
      item_id: "stage-item-result",
      type: "result",
...
export const mockGitDeliveryResultFeedEntry = {
  entry_id: "entry-delivery-result-delivery-record-git-1",
  run_id: "run-delivery",
  type: "delivery_result",
  occurred_at: "2026-05-01T08:44:00.000Z",
...
export const mockDeliveryResultDetailProjection: DeliveryResultDetailProjection = {
  ...
  identity: {
    ...
    records: {
      ...
      status: "succeeded",
      created_at: "2026-05-01T08:44:00.000Z",
      completed_at: "2026-05-01T08:44:00.000Z",
    },
    stable_refs: [
      "delivery-record-1",
      "run-completed",
  ...
  input: {
    ...
    records: {
      delivery_channel_snapshot: {
        ...
        last_validated_at: "2026-05-01T08:43:00.000Z",
      ...
      delivery_channel_snapshot_ref: "delivery-snapshot-1",
      stage_input_ref: "delivery-input-ref-1",
    },
    stable_refs: [
      "delivery-snapshot-1",
  ...
  process: {
    ...
    records: {
      delivery_process: {
        ...
        status: "succeeded",
        result_ref: "demo-delivery-result:run-completed",
        process_ref: "demo-delivery-process:run-completed",
        branch_name: "demo/run-completed",
        commit_sha: null,
        code_review_url: null,
      ...
      delivery_process_refs: ["demo-delivery-process:run-completed"],
    ...
    stable_refs: ["demo-delivery-process:run-completed"],
    log_refs: ["log-delivery-stage-1", "log-demo-1"],
    truncated: false,
    redaction_status: "none",
  },
  output: {
    ...
    stable_refs: ["demo-delivery-result:run-completed"],
    log_refs: [],
    truncated: false,
    redaction_status: "none",
  },
  artifacts: {
    title: "Artifacts",
    records: {
      artifact_refs: ["artifact-delivery-stage-1"],
      payload_refs: ["payload-delivery-stage-1"],
      artifact_types: ["delivery_result_trace"],
      delivery_artifacts: [
        "artifact-delivery-stage-1",
        "demo-delivery-result:run-completed",
        "demo-delivery-process:run-completed",
        "demo/run-completed",
      ],
      audit_refs: ["audit-demo-1"],
      log_summary_refs: ["log-demo-1"],
...
export const mockGitDeliveryResultDetailProjection: DeliveryResultDetailProjection = {
  delivery_record_id: "delivery-record-git-1",
  run_id: "run-delivery",
  delivery_mode: "git_auto_delivery",
  status: "succeeded",
  ...
  process: {
    ...
    records: {
      ...
      delivery_process_refs: ["git-delivery-process:run-delivery"],
      stage_status: "completed",
      delivery_result_event_ref: "event-delivery-result-1",
      audit_refs: ["audit-demo-1"],
      log_summary_refs: ["log-demo-1"],
    ...
    stable_refs: ["git-delivery-process:run-delivery"],
    log_refs: ["log-delivery-stage-1", "log-demo-1"],
    truncated: false,
    redaction_status: "none",
  },
  output: {
    ...
    stable_refs: ["git-delivery-result:run-delivery"],
    log_refs: [],
    truncated: false,
    redaction_status: "none",
  },
